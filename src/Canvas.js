...
// const Canvas = ({ settings, text, ...rest }) => {
...
//   //   console.log("update")
//   //   drawCanvas(getContext(), textRef.current); // re-draw with updated text
//   // }, [text]);


//   // const updateCanvasText = (newText) => {
//   //   setText({ text: newText });
//   //   canvasRef.current?.updateText(newText);
//   // };
...
//     lastPath.current = [];
//     drawModes(settings.current.mode, context.current, point, lastPath.current);
//   };
...
//       redoHistory.current = [];
//       lastPath.current = [];
//       drawCanvas(getContext(), textRef.current);
//     }
//   };
...
//     drawCanvas(ctx, textRef.current);
...
//   const drawCanvas = (ctx, textToDraw) => {
//     console.log(text, "from draw canvas")
//     clearCanvas(ctx);


//     ctx.font = "30px Arial";  // Set the font size and family
//     ctx.fillStyle = "black";  // Set the text color
//     //ctx.fillText(text.text, width/1.75, height*1.75);
//     // console.log(text, "drawcanvas")
//     // console.log(text.text, "below")
//     drawMultilineText(ctx, text.text, width / 1.75, height*1.75);
...
//   useEffect(() => {
//     context.current = canvas.current.getContext("2d");
//     drawCanvas(context.current, textRef.current);
//   }, [text, width, height]);
